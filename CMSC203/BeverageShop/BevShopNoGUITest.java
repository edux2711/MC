...
public class BevShopNoGUITest {
	...
	public static void main(String[] args) {
		...
		System.out.println(b.MAX_ORDER_FOR_ALCOHOL()); // 3
		System.out.println(b.MIN_AGE_FOR_ALCOHOL()); // 21
		...
		tempCustomer.setCustomerName("kim");
		tempCustomer.setCustomerAge(10);

		System.out.println(b.getCurrentOrder().getCustomer().getCustomerName()); // John
		System.out.println(b.getCurrentOrder().getCustomer().getCustomerAge()); // 23

		tempAge = b.getCurrentOrder().getCustomer().getCustomerAge();
		...
		if (b.validAge(b.getCurrentOrder().getCustomer().getCustomerAge())) {
