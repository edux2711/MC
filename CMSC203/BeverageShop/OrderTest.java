...
public class OrderTest {
	...
	public void testToString() {
		...
		assertTrue(r1.toString().contains( r1.getCustomer().getCustomerName()) );
		assertTrue(r1.toString().contains(r1.getBeverage(0).getSize().toString()) )  ;
		assertTrue(r1.toString().contains(r1.getBeverage(0).getBeverageName()) );
		
	 	 
		assertTrue(r1.toString().contains(r1.getBeverage(1).getSize().toString()) )  ;
		assertTrue(r1.toString().contains(r1.getBeverage(1).getBeverageName()) );
