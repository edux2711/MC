...
public class MyStackTest {
	...
	public void testPopStudent() {
		...
		try {
			assertEquals(ex2, doubleS.pop());
			assertEquals(ex1, doubleS.pop());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleS.pop();
			assertTrue("This should have caused an StackUnderflowException", false);
		}
	...
	public void testPushStudent() {
		...
		try {
			...
			assertEquals(true, doubleS.push(ex3));
			assertEquals(3, doubleS.size());
			assertEquals(true, doubleS.push(ex4));
	...
	public void testToStringStudent() {
		//Use the doubleQ for student tests
		assertEquals("1.02.2", doubleS.toString());
		doubleS.push(ex3);
		assertEquals("1.02.222.2", doubleS.toString());
		doubleS.push(ex4);
		assertEquals("1.02.222.25.5", doubleS.toString());	}
